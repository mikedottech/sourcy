// antlr3customtokenstream.c — Custom ANTLR3 token stream with selectively switchable channels.
//
...
//
static void		setTokenTypeChannel     (pANTLR3_CUSTOM_TOKEN_STREAM cts, ANTLR3_UINT32 ttype, ANTLR3_UINT32 channel);
static void		discardTokenType        (pANTLR3_CUSTOM_TOKEN_STREAM cts, ANTLR3_INT32 ttype);
static void		discardOffChannel       (pANTLR3_CUSTOM_TOKEN_STREAM cts, ANTLR3_BOOLEAN discard);
static pANTLR3_VECTOR	getTokens	        (pANTLR3_CUSTOM_TOKEN_STREAM cts);
static pANTLR3_LIST	getTokenRange	        (pANTLR3_CUSTOM_TOKEN_STREAM cts, ANTLR3_UINT32 start, ANTLR3_UINT32 stop);
static pANTLR3_LIST	getTokensSet	        (pANTLR3_CUSTOM_TOKEN_STREAM cts, ANTLR3_UINT32 start, ANTLR3_UINT32 stop, pANTLR3_BITSET types);
static pANTLR3_LIST	getTokensList	        (pANTLR3_CUSTOM_TOKEN_STREAM cts, ANTLR3_UINT32 start, ANTLR3_UINT32 stop, pANTLR3_LIST list);
static pANTLR3_LIST	getTokensType	        (pANTLR3_CUSTOM_TOKEN_STREAM cts, ANTLR3_UINT32 start, ANTLR3_UINT32 stop, ANTLR3_UINT32 type);
static void             reset                   (pANTLR3_CUSTOM_TOKEN_STREAM cts);
...
static void		    antlr3CTSFree		(pANTLR3_CUSTOM_TOKEN_STREAM    stream);

// Helpers
//
static void		    fillBuffer			(pANTLR3_CUSTOM_TOKEN_STREAM tokenStream);
static ANTLR3_UINT32	    skipOffTokenChannels	(pANTLR3_CUSTOM_TOKEN_STREAM tokenStream, ANTLR3_INT32 i);
static ANTLR3_UINT32	    skipOffTokenChannelsReverse (pANTLR3_CUSTOM_TOKEN_STREAM tokenStream, ANTLR3_INT32 i);
static pANTLR3_COMMON_TOKEN LB				(pANTLR3_CUSTOM_TOKEN_STREAM tokenStream, ANTLR3_INT32 i);
...
static void		    
antlr3CTSFree	    (pANTLR3_CUSTOM_TOKEN_STREAM stream)
{
...
//
static void             
reset   (pANTLR3_CUSTOM_TOKEN_STREAM cts)
{
...
{
    pANTLR3_CUSTOM_TOKEN_STREAM	stream;

	// Create a standard token stream
	//
	stream = antlr3CustomTokenStreamSourceNew(hint, source);
...
antlr3CustomTokenStreamSourceNew(ANTLR3_UINT32 hint, pANTLR3_TOKEN_SOURCE source)
{
    ...
    stream = antlr3CustomTokenStreamNew(hint);
...
antlr3CustomTokenStreamNew(ANTLR3_UINT32 hint)
{
    ...
    /* Memory for the interface structure
     */
    stream  = (pANTLR3_CUSTOM_TOKEN_STREAM) ANTLR3_MALLOC(sizeof(ANTLR3_CUSTOM_TOKEN_STREAM));
...
tokLT  (pANTLR3_TOKEN_STREAM ts, ANTLR3_INT32 k)
{
	ANTLR3_INT32    i;
	ANTLR3_INT32    n;
	pANTLR3_CUSTOM_TOKEN_STREAM cts;

	cts	    = (pANTLR3_CUSTOM_TOKEN_STREAM)ts->super;
...
static pANTLR3_COMMON_TOKEN
LB(pANTLR3_CUSTOM_TOKEN_STREAM cts, ANTLR3_INT32 k)
{
    ANTLR3_INT32 i;
    ANTLR3_INT32 n;
 ...
 */
static void		    
setTokenTypeChannel (pANTLR3_CUSTOM_TOKEN_STREAM tokenStream, ANTLR3_UINT32 ttype, ANTLR3_UINT32 channel)
{
...
static void		    
discardTokenType    (pANTLR3_CUSTOM_TOKEN_STREAM tokenStream, ANTLR3_INT32 ttype)
{
...
static void		    
discardOffChannel   (pANTLR3_CUSTOM_TOKEN_STREAM tokenStream, ANTLR3_BOOLEAN discard)
{
    tokenStream->discardOffChannel  = discard;
}

static pANTLR3_VECTOR	    
getTokens   (pANTLR3_CUSTOM_TOKEN_STREAM tokenStream)
{
    if	(tokenStream->p == -1)
    {
...
static pANTLR3_LIST	    
getTokenRange	(pANTLR3_CUSTOM_TOKEN_STREAM tokenStream, ANTLR3_UINT32 start, ANTLR3_UINT32 stop)
{
 ...
 */
static pANTLR3_LIST	    
getTokensSet	(pANTLR3_CUSTOM_TOKEN_STREAM tokenStream, ANTLR3_UINT32 start, ANTLR3_UINT32 stop, pANTLR3_BITSET types)
{
...
static pANTLR3_LIST	    
getTokensList	(pANTLR3_CUSTOM_TOKEN_STREAM tokenStream, ANTLR3_UINT32 start, ANTLR3_UINT32 stop, pANTLR3_LIST list)
{
...
static pANTLR3_LIST	    
getTokensType	(pANTLR3_CUSTOM_TOKEN_STREAM tokenStream, ANTLR3_UINT32 start, ANTLR3_UINT32 stop, ANTLR3_UINT32 type)
{
    pANTLR3_BITSET  bitSet;
    pANTLR3_LIST    newlist;
...
ANTLR3_API void
fillBufferExt(pANTLR3_COMMON_TOKEN_STREAM /*pANTLR3_CUSTOM_TOKEN_STREAM*/ tokenStream)
{
    fillBuffer((pANTLR3_CUSTOM_TOKEN_STREAM*)tokenStream);
}
static void
fillBuffer(pANTLR3_CUSTOM_TOKEN_STREAM tokenStream) {
    ANTLR3_UINT32 index;
...
///
static ANTLR3_UINT32
skipOffTokenChannels(pANTLR3_CUSTOM_TOKEN_STREAM tokenStream, ANTLR3_INT32 i) {
    ANTLR3_INT32 n;
    pANTLR3_COMMON_TOKEN tok;
	...
	while (i < n)
    {
		...
		if ((tok->channel == ANTLR3_TOKEN_SWITCHABLE_CHANNEL && tokenStream->swChannelState <= 0))
		{			
			return i;
		}
...
static ANTLR3_UINT32
skipOffTokenChannelsReverse(pANTLR3_CUSTOM_TOKEN_STREAM tokenStream, ANTLR3_INT32 x)
{
    pANTLR3_COMMON_TOKEN tok;
    ...
    while (x >= 0)
    {
        ...
        if(tok->channel == ANTLR3_TOKEN_SWITCHABLE_CHANNEL)
		{
			return x;
		} else
		if ((tok->channel != tokenStream->channel))
